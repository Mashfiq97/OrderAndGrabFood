...
import com.example.foody_v6_11dec.Model.AdminOrders;

import com.example.foody_v6_11dec.ViewHolder.AdminOrdersViewholder;
...
public class AdminNewOrdersActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ordersList = (RecyclerView) findViewById(R.id.admin_new_order_recycler_view);
        ...
        FirebaseRecyclerAdapter<AdminOrders, AdminOrdersViewholder> adapter =
                new FirebaseRecyclerAdapter<AdminOrders, AdminOrdersViewholder>(options) {
                    ...
                    protected void onBindViewHolder(@NonNull AdminOrdersViewholder adminOrdersViewHolder, final int position, @NonNull AdminOrders adminOrders) {
                        ...
                        adminOrdersViewHolder.userTotalPrice.setText("Total Amount= Tk " + adminOrders.getTotalAmount());
                        ...
                        adminOrdersViewHolder.itemView.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view)
                            {
                                ...
                                builder.setTitle("Has the Order been shipped Already?");
